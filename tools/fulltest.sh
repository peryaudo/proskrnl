...
ALL_LEGS=(winetest-gui winetest wow64gui wow64aud winefbunit gui5con gui6 coldinput usbinput tornwrite gui4 cui8 gui3 gui5 gui2 cui9
...
run_leg() {
    ...
    *)
        ...
        boot)
            ...
            ;;
        gui2|gui3|gui4|gui5|gui5con|wow64gui|usbinput)
