---
name: gate-check
description: Review the current diff against proskrnl's constitution (docs/09-constitution.md) and the G1-G11 PR gates (docs/CONTRIBUTING.md), flagging boundary violations before commit. Use before committing kernel/abi/driver changes, or when the user asks to "check the gates" / "is this constitutional".
---
