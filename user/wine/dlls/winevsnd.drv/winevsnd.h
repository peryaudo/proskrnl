...
extern NTSTATUS vsnd_get_capture_buffer(void *args);
extern NTSTATUS vsnd_release_capture_buffer(void *args);
extern NTSTATUS vsnd_get_next_packet_size(void *args);
