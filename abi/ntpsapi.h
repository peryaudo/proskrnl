...
_Static_assert(sizeof(PROCESS_STACK_ALLOCATION_INFORMATION) == 24, "PROCESS_STACK_ALLOCATION_INFORMATION x64 layout");
_Static_assert(offsetof(PROCESS_STACK_ALLOCATION_INFORMATION, StackBase) == 16, "PROCESS_STACK_ALLOCATION_INFORMATION x64 layout");
_Static_assert(sizeof(PROCESS_STACK_ALLOCATION_INFORMATION_EX) == 40, "PROCESS_STACK_ALLOCATION_INFORMATION_EX x64 layout");
_Static_assert(offsetof(PROCESS_STACK_ALLOCATION_INFORMATION_EX, AllocInfo) == 16, "PROCESS_STACK_ALLOCATION_INFORMATION_EX x64 layout");
